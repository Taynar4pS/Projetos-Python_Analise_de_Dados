...
![Dispersão Idade vs Salário](Outputs/Imagens/Matplotlib/Dispercao_idade_vs_salario.png)  
...
![Distribuição do Nível de Escolaridade](Outputs/Imagens/Matplotlib/Distribuicao_nivel_escolaridade.png)  
...
![Divisão por Escolaridade](Outputs/Imagens/Matplotlib/Divisao_escolaridade.png)  
...
![Densidade dos Salários](Outputs/Imagens/Seanborn/Densidade_salarios.png)  
*Curva de densidade que ilustra a distribuição dos salários no conjunto de dados, mostrando onde se concentram os valores.*

![Idade vs Salário](Outputs/Imagens/Seanborn/Idade_vs_salario.png)  
*Gráfico de dispersão com ajuste visual mais refinado, mostrando a relação entre idade e salário.*

![Quantidade de Clientes por Estado Civil e Nível de Educação](Outputs/Imagens/Seanborn/Qtd_clientes-estado_civil-nivel_educacao.png)  
*Gráfico de barras agrupadas exibindo a quantidade de clientes distribuídos por estado civil e nível de educação.*

![Regressão Salário por Idade](Outputs/Imagens/Seanborn/Regressao_salario_por_idade.png)  
*Gráfico com linha de regressão que modela a relação entre salário e idade, indicando a tendência geral dos dados.*

![Salário, Idade e Anos de Experiência](Outputs/Imagens/Seanborn/Salario_idade_anos_de_experiencia.png)  
